...
public class LoginOwner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_forgotPassword.setOnClickListener(v -> startActivity(new Intent(LoginOwner.this, ResetPasswordOwenr.class)));
        ...
        tv_registerBtn.setOnClickListener(v -> startActivity(new Intent(LoginOwner.this, RegisterOwner.class)));
