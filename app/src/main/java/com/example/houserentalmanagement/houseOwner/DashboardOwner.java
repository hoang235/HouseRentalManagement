...
public class DashboardOwner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_seeHouse.setOnClickListener(v -> startActivity(new Intent(DashboardOwner.this, SeeHouse.class)));

        btn_addHouse.setOnClickListener(v -> startActivity(new Intent(DashboardOwner.this, AddHouse.class)));
    }
}