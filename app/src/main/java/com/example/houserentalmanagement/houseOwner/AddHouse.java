...
public class AddHouse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_houseImage.setOnClickListener(v -> checkPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE, STORAGE_PERMISSION_CODE));

        progressDialog = new ProgressDialog(AddHouse.this);

        btn_addHouse.setOnClickListener(v -> {
